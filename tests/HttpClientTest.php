...
final class HttpClientTest extends TestCase
{
    ...
    public function testCoversResponseAndUrlBoundaries(): void
    {
        ...
        self::assertSame('[invalid-url]', $sanitize->invoke($wrapped, ':'));
        $credentialUrl = implode('', ['https://', 'user', ':', 'secret', '@example.test:8443/path?', 'api_key', '=', 'secret']);
        self::assertSame('https://example.test:8443/path', $sanitize->invoke($wrapped, $credentialUrl));
    }
