...
trait VehicleServiceEndpoints
{
     ...
     * @return mixed
     */
    public function listVehicleInspections($parameters = [], $options = [], $requestOptions = [])
    {
        return $this->endpointFromArguments('GET', '{{base_url}}/{{namespace}}/vehicles/:id/inspections', ['id'], 'query', func_get_args());
    }
